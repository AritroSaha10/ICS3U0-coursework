# -----------------------------------------------------------------------------
# Name:        Assertion Practice
# Purpose:     Practice proper assertion techniques
#
# Author:      Aritro Saha
# Created:     19-Apr-2022
# Updated:     19-Apr-2022
...
assert saleCalc(-100,
                50) == "Error.", "Impossible to deduct from a negative pricce"
assert saleCalc(100, -50) == "Error.", "Impossible to have a negative discount"
assert saleCalc(
    100, 120) == "Error.", "Impossible to have a discount more than 100%"
